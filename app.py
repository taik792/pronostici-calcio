...
def ai_oracle_v18():
    ...
    try:
        ...
        # --- MATRICE DI TUTTE LE COMBO POSSIBILI ---
        # Il motore le calcolerà tutte e cercherà quella con il punteggio più alto
        ranges = [(1,2), (1,3), (1,4), (2,3), (2,4), (2,5)]
        all_options = []

        # Testiamo Combo 1X + MG Casa
        for mi, ma in ranges:
        ...
        # --- OUTPUT ---
        print("\n" + "🎯" * 5 + " IL PRONOSTICO DEL MOTORE " + "🎯" * 5)
        print("-" * 50)
        print(f"CONSIGLIO UNICO: {best_desc}")
        ...
        print("\n" + "Nota: Il motore ha scelto questa combo perché ha la probabilità")
        print("matematica più alta tra tutte le combinazioni possibili.")
        print("="*65)
